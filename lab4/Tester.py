...
class Test_model(VAE_Model):
    ...
    def val_one_step(self, img, label, idx=0):
        ...
        for t in range(1, 630):
            ...
            pose_label = label[t].to(self.args.device)

            frame_feat = self.frame_transformation(prev_frame)
            label_feat = self.label_transformation(pose_label)
            ...
            label_list.append(pose_label.cpu())
...
if __name__ == '__main__':
    ...
    parser.add_argument('--kl_anneal_type',     type=str, default='',       help="")
    parser.add_argument('--kl_anneal_cycle',    type=int, default=10,               help="")
    parser.add_argument('--kl_anneal_ratio',    type=float, default=0.75,              help="")
